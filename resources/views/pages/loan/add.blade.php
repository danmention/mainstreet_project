                        ...
                        <form action="" method="POST" id="add-loan">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input class="form-control" name="duration" id="duration" placeholder="Enter a duration"
                                           name="duration" value="{{ old('duration') }}" type="number">
                                    <span class="err">*Required</span>
                                </div>
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <textarea class="form-control custom-select d-block w-100" id="desc" name="description"></textarea>
                                    <span class="err">*Required</span>
                                </div>
                            </div>
