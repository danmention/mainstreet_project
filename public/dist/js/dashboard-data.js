...
$(document).ready(function() {
	...
	$.toast({
		heading: 'Welcome!',
		text: '<p>You have successfully logged in!',
		position: 'top-right',
		loaderBg:'#7a5449',
...
var echartsConfig = function() { 
	...
	if( $('#e_chart_5').length > 0 ){
		...
		var option4 = {
			color: ['#7a5449', '#a58b84','#bca9a4','#d592d4','#f6f3f2'],		
			tooltip: {
				show: true,
				trigger: 'axis',
				backgroundColor: '#fff',
	...
	if( $('#e_chart_6').length > 0 ){
		...
		var option5 = {
			...
			series: [
				{
					data:[420, 332, 401, 334, 400, 330, 410, 420, 332, 401, 334, 400],
					type: 'bar',
					barMaxWidth: 20,
				},
				{
					data: [120, 152, 251, 124, 250, 120, 110, 120, 152, 251, 124, 250],
					type: 'line',
					symbolSize: 6,
					smooth: true,
					itemStyle: {
